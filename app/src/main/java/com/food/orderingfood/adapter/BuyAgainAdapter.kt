...
import com.food.orderingfood.databinding.BuyAgainItemBinding
...
class BuyAgainAdapter(
    ...
    class BuyAgainViewHolder(private val binding: BuyAgainItemBinding) :
        ...
        fun bind(foodName: String, foodPrice: String, foodImage: Int) {
            binding.butAgainFoodName.text = foodName
            binding.butAgainFoodPrice.text = foodPrice
            binding.butAgainFoodImage.setImageResource(foodImage)
        }
    }
